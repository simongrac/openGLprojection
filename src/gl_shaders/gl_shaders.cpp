...
#include <shaders/shader_vert_glsl.h>
#include <shaders/shader_frag_glsl.h>
...
int main(){
    ...
    Shader program = {shader_vert_glsl, shader_frag_glsl};
...
//    // uniformShader
//    int uniformShader = glCreateShader(GL_FRAGMENT_SHADER);
